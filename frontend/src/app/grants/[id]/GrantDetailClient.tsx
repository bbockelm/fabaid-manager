    ...
    <div className="max-w-6xl space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-500">
          Award #{grant.award_number} &middot; PI: {grant.pi_name} &middot; {grant.agency}
        </p>
        <p className="text-sm text-gray-400 mt-1">
          {grant.start_date} to {grant.end_date} &middot; Total Budget: $
            ...
            <tbody className="divide-y">
              {subawards?.map((sub) => (
                <tr key={sub.id}>
                  ...
                  <td className="px-4 py-2 text-sm">
                    {sub.start_date} &mdash; {sub.end_date}
                  </td>
